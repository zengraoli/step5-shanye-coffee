...
describe('时间格式化', () => {
  test('UTC ISO8601 转北京时间', () => {
    ...
    expect(formatBeijingShort('2026-09-26T16:05:00.000Z')).toBe('09-27 00:05')
...
describe('等级文案', () => {
  test('三档等级', () => {
    expect(LEVEL_TEXT.silver).toBe('银卡')
    expect(LEVEL_TEXT.gold).toBe('金卡')
    expect(LEVEL_TEXT.black).toBe('黑卡')
  })
})
